<div class="msgme" style="padding: 5px;">
  <div class="media">
    ...
    <div class="media-right media-middle">
      <a href="/profil/<?php echo $pseudo_usermsg; ?>" title="<?php echo $name_pseudo_usermsg; ?>">
        <img class="img-circle media-object" src="<?php echo $imgprofil_pseudo_usermsg; ?>" alt="<?php echo $name_pseudo_usermsg; ?>" style="width: 50px;height: 50px;">
      </a>
    </div>
  </div>
</div>